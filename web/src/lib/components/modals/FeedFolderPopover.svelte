    ...
    >
      ...
      >
        <div class="flex items-center gap-3">
          <div
            class="w-8 h-8 rounded-lg bg-gradient-to-br from-blue-500/20 to-cyan-500/20 border border-blue-500/20 flex items-center justify-center"
          >
            <FolderPlus size={16} class="text-blue-400" />
          </div>
      ...
      <div class="p-3 max-h-[400px] overflow-y-auto">
            ...
            {#each $folders as folder}
              ...
              >
                <input
                  ...
                  class="w-4 h-4 rounded border-white/20 bg-white/5 text-blue-500 focus:ring-2 focus:ring-blue-500/50 focus:ring-offset-0 cursor-pointer"
                />
        ...
        <div class="mt-3 pt-3 border-t border-white/5">
          {#if !showCreateFolder}
            <button
              class="w-full flex items-center justify-center gap-2 px-3 py-2.5 rounded-xl border border-dashed border-white/20 hover:border-blue-500/50 hover:bg-blue-500/5 text-white/60 hover:text-blue-400 transition-all text-sm font-medium"
          ...
          {:else}
            <div class="flex gap-2">
              <input
                ...
                class="flex-1 bg-white/5 px-3 py-2 rounded-lg text-white placeholder-white/40 border border-white/10 focus:border-blue-500/50 transition-colors outline-none text-sm"
                maxlength="60"
                on:keydown={(e) => e.key === "Enter" && handleCreateFolder()}
                autofocus
              />
              <button
                class="px-4 py-2 rounded-lg bg-blue-500 text-white hover:bg-blue-600 transition-colors text-sm font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
